...
\textit{Origem do drama barroco alemão}. Walter Benjamin; tradução de\\ 
Sérgio Paulo Rouanet. 1ª\,ed. Título original: \textit{Ursprung des deutschen\\ 
Barockdramas}. São Paulo, \textsc{sp}: Editora Hedra, 2024.\\

\textsc{isbn} 978-85-7715-778-5\\

1. Filosofia alemã 2. Teatro alemão: História e crítica\\ 
\textsc{i}. Rouanet, Sérgio Paulo. \textsc{ii}. Título.\\

24--222842 \hfill \textsc{cdd}: 832.912\\
\textbf{\hrule}\smallskip
...
1. Teatro alemão: História e crítica (832.912)
\end{minipage}
